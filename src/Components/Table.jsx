...
// import image from '../../public/assets/gifs/back.jpg'
...
const UserTable = () => {
  ...
  return (
    <>
      <div style={{width: "99.9vw", height:'98vh', margin:'0px',padding:0, background: 'rgb(34,193,195)',background: 'linear-gradient(0deg, rgba(34,193,195,1) 0%, rgba(225,203,154,1) 100%)'}} >
